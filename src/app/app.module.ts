...
import { ClientSession1Component } from './client-session1/client-session1.component';
...
@NgModule({
  declarations: [
    ...
    Comp2Component,
    Comp3Component,
    CompPersonneComponent,
    CompArticle1Component,
    CompArticle2Component,
    App7Component,
    App8Component,
    App6Component,
    Comp4Component,
    ...
    Session1Component,
    Session2Component,
    CompSessionComponent,
    ClientSession1Component,
    ClientSession2Component,
    CompClientSession1Component,
    CompClientSession2Component,
    FindallComponent,
    CompFindallComponent,
    Findallv2Component,
    CompFindallv2Component,
    FindidComponent,
    FindbyidComponent,
    Createv1Component,
    Createv2Component,
    CompFindbyidComponent,
    CompCreateComponent,
    DeleteComponent,
    UpdateComponent,
    CompDeletev1Component,
    CompDeletev2Component,
    CompFactureComponent,
    Createv3Component,
    Deletev2Component,
    CompUpdateComponent,
    CompCreatev2Component,
    CompDeletev3Component,
    Createv4Component,
    Findallv3Component,
    CompCreatev3Component,
    CompFindallv3Component,
    LoginComponent
  ],
  imports: [
    BrowserModule,
